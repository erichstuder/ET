...
<sheet>
<plain>
<text x="-27.94" y="83.82" size="1.778" layer="91">The schematic shall be short-circuit-save.

Arduino Leonardo
absolute maximum for GPIO: 40mA
minimal high level output voltage @ 5V = 4.2V
maximal low level output voltage @ 5V = 0.7V

Up Board (74LVC1T45)
24 mA source and sink at 3V
minimal high level input voltage @ 3.3V = 2.0V
maximal low level input voltage @ 3.3V = 0.8V

=&gt; decision: no higher current than 1mA

1mA @ 5V = 5 kOhm =&gt; 5.6 kOhm = R1
Voltage divider from 5V to about 3.3V =&gt; 8.2 kOhm = R2</text>
<text x="12.7" y="53.34" size="1.778" layer="91">GPIO in to Up Board
0..3.3V</text>
<text x="-40.64" y="60.96" size="1.778" layer="91">GPIO out from Arduino Leonardo
0..5V</text>
</plain>
<instances>
<instance part="R1" gate="G$1" x="0" y="71.12" smashed="yes" rot="R90">
<attribute name="NAME" x="-1.4986" y="67.31" size="1.778" layer="95" rot="R90"/>
<attribute name="VALUE" x="3.302" y="67.31" size="1.778" layer="96" rot="R90"/>
</instance>
<instance part="R2" gate="G$1" x="0" y="55.88" smashed="yes" rot="R90">
